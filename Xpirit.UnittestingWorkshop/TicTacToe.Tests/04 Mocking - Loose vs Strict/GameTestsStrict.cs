...
namespace TicTacToe.Tests
{
    public class GameTestsStrict
    {
        ...
        [Fact(Skip = "Check out this error message")]
        public async Task TestPlayerHasHighScoreAfterGamePlay_V1()
        {
            //Arrange
            const string playerName = "Reinier";
        ...
        public async Task TestPlayerHasHighScoreAfterGamePlay_V2()
        {
            ...
            //Show verify for even more checks. Beware of the consequence: tight coupling of tests with code!
            //HighScoreServiceMock.Setup(service => service.GetHighScoreAsync("Piet")).Returns(Task.FromResult(99));
